...
export const UsernameModal = ({ isOpen, setIsOpen, setUsername }) => {
  ...
  return (
    <Modal
      ...
      actions={
        <Button type="submit" form="username-form" autoFocus withIcon base className="w-full rounded-none rounded-b-lg hover:text-gray-200 text-xl">Join <IoMdExit size={24} /></Button>
      }
    />
  );
};
