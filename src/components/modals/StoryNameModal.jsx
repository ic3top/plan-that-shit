    ...
    <Modal
      ...
      content={(
        <div className="flex flex-col items-center py-4 px-16">
          <form id="name-form" onSubmit={onStartVoting}>
            <input
      ...
      actions={(
        <>
          ...
          <Button type="submit" form="name-form" withIcon outline>Start Voting</Button>
        </>
     )}
    />
  );
