...
export const NewRoomModal = ({ isOpen, setIsShown, roomId, loading }) => {
    ...
    <Modal
      ...
      actions={
        <>
          ...
          <Button withIcon outline onClick={() => navigateTo('/' + roomId)} disabled={loading}>JOIN <IoMdExit size={24} /></Button>
        </>
      }
    />
  )
